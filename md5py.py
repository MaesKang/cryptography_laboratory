...
if __name__ == "__main__":
    ...
    M.update("abc")
    print M.hexdigest()
    M.update("message digest")
    print M.hexdigest()
    M.update("abcdefghijklmnopqrstuvwxyz")
    print M.hexdigest()
    M.update("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789")
    print M.hexdigest()
    M.update("12345678901234567890123456789012345678901234567890123456789012345678901234567890")
    print M.hexdigest()
